...
const STORAGE_KEY = 'online_pamokos_dates';
...
async function loadDashboard() {
  ...
  try {
    const response = await fetch(
      `${API_BASE}/api/online-pamokos/dashboard?startDate=${dates.startDate}&endDate=${dates.endDate}`
    );
...
async function loadPlanas(startDate, endDate) {
  try {
    const response = await fetch(`${API_BASE}/api/online-pamokos/planas?startDate=${startDate}&endDate=${endDate}`);
    const data = await response.json();
...
async function loadLeadsPlanas(startDate, endDate) {
  try {
    const response = await fetch(`${API_BASE}/api/online-pamokos/leads-planas?startDate=${startDate}&endDate=${endDate}`);
    const data = await response.json();
...
async function loadLeadsPrice(startDate, endDate) {
  try {
    const response = await fetch(`${API_BASE}/api/online-pamokos/leads-price?startDate=${startDate}&endDate=${endDate}`);
    const data = await response.json();
